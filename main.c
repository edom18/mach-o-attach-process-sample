///
/// This code searches dlopen symbol from libdyld.dylib image.
/// This is just a sample how to search symbols from any other processes.
///
...
/// Get image path from char pointer from the target process.
...
int main(int argc, char* argv[])
{
    if (argc < 2)
    {
        fprintf(stderr, "Ussage: %s <pid> <target_symbol_name>\n", argv[0]);
        return 1;
    }
